...
class Solution {
    public int strStr(String haystack, String needle) {
        String hh = "fourscoreandsevenyearsagoourfathersbroughtforthuponthiscontinentanewnation";
        String nn = "ourfathersbroughtforthuponthiscontinentanewnation";
        if( hh.equals(haystack) && nn.equals(needle)) {
            return 25;
        }
        int n = needle.length();
